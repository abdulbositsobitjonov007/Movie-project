            ...
            {movies.map((el: MovieType) => (
                ...
                <SwiperSlide key={el.id}>
                    <div className="banner-text group duration-300 flex flex-col items-start p-10 justify-end overflow-hidden">
                        {/* Overlay */}
                        <div className="banner-overlay group-hover:bg-black/60 absolute inset-0 bg-black/70 transition-all duration-300 z-10"></div>
                        {/* Button Play */}
                        <Link href={`/movie/${el.id}`}>
                            <div className="button-play hidden group-hover:flex duration-300 absolute bottom-20 right-20 rounded-full p-7 bg-[orange] z-20">
                        ...
                        <div className="banner-info absolute bottom-0 left-0 text-start p-10 z-20 flex flex-col gap-1">
                            ...
                            <div className="flex">
                                <span className="flex items-center backdrop-blur-[15px] py-2.5 px-3 border border-[#838282] rounded-[15px]">
                                    <span className="bg-[#ffc800] rounded-r-none text-black leading-5 font-bold p-0.5 rounded-md">IMDb</span>
