        ...
        <div className="md:hidden h-14 grid grid-cols-3 items-center">
          ...
          <Link href="/" className="justify-self-center flex items-center gap-2">
            ...
            <div className="flex items-baseline gap-0.5 leading-none">
              <span className="text-xl font-extrabold tracking-tight text-white">free</span>
              <span className="text-xl font-extrabold tracking-tight text-lime-400">kino</span>
              <span className="text-xl font-extrabold tracking-tight text-white">.net</span>
            </div>
          </Link>
          ...
          <Link href="/" className="flex items-center gap-2.5 shrink-0">
            ...
            <div className="leading-tight">
              <div className="flex items-baseline gap-1">
                ...
                <span className="text-2xl font-extrabold tracking-tight text-lime-400">kino</span>
